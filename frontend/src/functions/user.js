...
const updateprofilePicture = async (url, token) => {
  try {
...
const updateCover = async (url, token) => {
  try {
    const { data } = await axios.put(
...
const addFriend = async (id, token) => {
  try {
    const { data } = await axios.put(
...
const cancelRequest = async (id, token) => {
  try {
    const { data } = await axios.put(
...
const removeFromSearch = async (searchUser, token) => {
  try {
    const { data } = await axios.put(
...
const getFriendsPageInfos = async (token) => {
  try {
    const { data } = await axios.get(
