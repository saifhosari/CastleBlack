          ...
          <div className="header_col">
            ...
            <div className="post_profile_privacy_date">
              <Moment fromNow interval={30}>
                {/* setInterval updates it every 30 seconds */}
                {post.createdAt}
              </Moment>
              . <Public color="var(--darkGold-color)" />
            </div>
          </div>
        </Link>
        <div
