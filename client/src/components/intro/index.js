  ...
  return (
    <div className="profile_card">
      ...
      {!details?.bio && !showBio && !visitor && (
        <button
          className="gray_btn hover4 w100"
          onClick={() => setShowBio(true)}
        >
          Add Bio
        </button>
      ...
      {!visitor && (
        <button className="blue_btn hover4 w100" onClick={()=>setVisible(true)}>Edit Details</button>
      )}
      {visible && !visitor && (
        <EditDetails
          details={details}
      ...
      {!visitor && (
        <button className="gray_btn hover4 w100 wtf">Add Hobbies</button>
      )}
      {!visitor && (
        <button className="blue_btn hover4 w100">Add Featured</button>
      )}
    </div>
  );
};
